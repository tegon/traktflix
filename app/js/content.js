...
var correctTitles = (_correctTitles = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "Star Wars: The Clone Wars", "\"Star Wars: The Clone Wars\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The Office (U.S.)", "The Office (US)"), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The Blind Side", "\"The Blind Side\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The Avengers", "\"The Avengers\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The Seven Deadly Sins", "\"The Seven Deadly Sins\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "Young and Hungry", "\"Young and Hungry\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The 100", "\"The 100\""), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "The House of Cards Trilogy (BBC)", "The House of Cards"), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "Shameless (U.S.)", "Shameless"), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_correctTitles, "Dynasty", "Dynasty reboot"), _correctTitles);
...
/* harmony import */ var _NetflixApiUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./NetflixApiUtils */ "./src/class/NetflixApiUtils.js");
...
function () {
  function ItemParser() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, ItemParser);

    this.id = null;
  } // For testing purposes.


  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(ItemParser, [{
    key: "getLocation",
    ...
    value: function isReady() {
      var isReady = false;
      var matches = this.getLocation().match(/watch\/(\d+)/);
    ...
    key: "checkIsReady",
    value: function () {
      var _checkIsReady = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _NetflixApiUtils__WEBPACK_IMPORTED_MODULE_4__["default"].getMetadata(this.id);
      ...
      function checkIsReady(_x) {
        return _checkIsReady.apply(this, arguments);
      }
    ...
    value: function start() {
      ...
      return new Promise(function (resolve) {
        return _this.checkIsReady(resolve);
      });
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (itemParser);

/***/ }),

/***/ "./src/class/NetflixApiUtils.js":
/*!**************************************!*\
  !*** ./src/class/NetflixApiUtils.js ***!
  \**************************************/
/*! exports provided: default */
...
/* harmony import */ var _BrowserStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BrowserStorage */ "./src/class/BrowserStorage.js");
/* harmony import */ var _Item__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Item */ "./src/class/Item.js");
/* harmony import */ var _Permissions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Permissions */ "./src/class/Permissions.js");
/* harmony import */ var _Request__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Request */ "./src/class/Request.js");
/* harmony import */ var _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./history-sync/ActivityActionCreators */ "./src/class/history-sync/ActivityActionCreators.js");
/* harmony import */ var _history_sync_TraktWebAPIUtils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./history-sync/TraktWebAPIUtils */ "./src/class/history-sync/TraktWebAPIUtils.js");
...
var AUTH_REGEXP = new RegExp("\"authURL\":\"(.*?)\"");
var BUILD_IDENTIFIER_REGEXP = new RegExp("\"BUILD_IDENTIFIER\":\"(.*?)\"");
var NETFLIX_HOST = "https://www.netflix.com";
var NETFLIX_API_HOST = "".concat(NETFLIX_HOST, "/api/shakti");
var netflixApiUtils = {
  authUrl: "",
  buildIdentifier: "",
  isActivated: false,
  extractAuthURL: function extractAuthURL(response) {
    return AUTH_REGEXP.exec(response)[1];
  },
  extractBuildIdentifier: function extractBuildIdentifier(response) {
    return BUILD_IDENTIFIER_REGEXP.exec(response)[1];
  },
  activateAPI: function activateAPI() {
    var _this = this;
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(resolve, reject) {
        var defs;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                if (defs.authUrl && defs.buildIdentifier) {
                  _this.authUrl = defs.authUrl;
                  _this.buildIdentifier = defs.buildIdentifier;
                  _this.isActivated = true;
                  resolve();
                } else {
                  // noinspection JSIgnoredPromiseFromCall
                  _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
                    method: "GET",
                    url: "".concat(NETFLIX_HOST, "/Activate"),
                    success: function success(response) {
                      _this.authUrl = _this.extractAuthURL(response);
                      _this.buildIdentifier = _this.extractBuildIdentifier(response);
                      _this.isActivated = true;
                      resolve();
                    },
                    error: reject
  ...
  listActivities: function () {
    var _listActivities = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(page, lastPage) {
      var loadAll, isLastPage, activities, response, _activities, result, parsedActivities, promises, storage;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              if (!(!isLastPage && (loadAll || page <= lastPage))) {
                _context2.next = 22;
                break;
              }

              _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].updatePage(page);
              _context2.prev = 6;
              _context2.next = 9;
              return _Request__WEBPACK_IMPORTED_MODULE_7__["default"].sendAndWait({
                method: "GET",
                url: "".concat(NETFLIX_API_HOST, "/").concat(this.buildIdentifier, "/viewingactivity?languages=en-US&authURL=").concat(this.authUrl, "&pg=").concat(page)
              });

            case 9:
              response = _context2.sent;
              _activities = JSON.parse(response).viewedItems;

              if (_activities.length) {
                activities.push.apply(activities, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(_activities));
              } else {
                isLastPage = true;
              }
            ...
            case 15:
              ...
              _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].receiveActivitiesFailed(_context2.t0.status, _context2.t0.response);
              console.log(_context2.t0.status, _context2.t0.response);
            ...
            case 22:
              _context2.next = 24;
              return this.getActivitiesMetadata(activities);

            case 24:
              _context2.t1 = this.parseActivity.bind(this);
              result = _context2.sent.map(_context2.t1);
              parsedActivities = result.map(function (item) {
                return item.parsedItem;
              });
              promises = result.map(function (item) {
                return item.promise;
              });
              _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].receiveActivities(parsedActivities, page);
              _context2.next = 31;
              return _BrowserStorage__WEBPACK_IMPORTED_MODULE_4__["default"].get("options");

            case 31:
              storage = _context2.sent;
              _context2.t2 = storage.options && storage.options.sendReceiveSuggestions;
              ...
              _context2.next = 36;
              return _Permissions__WEBPACK_IMPORTED_MODULE_6__["default"].contains(undefined, ["*://script.google.com/*", "*://script.googleusercontent.com/*"]);
            ...
            case 37:
              ...
              _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
                method: "GET",
                url: "https://script.google.com/macros/s/AKfycbxaD_VEcZVv9atICZm00TWvF3XqkwykWtlGE8Ne39EMcjW5m3w/exec?ids=".concat(encodeURIComponent(JSON.stringify(parsedActivities.map(function (activity) {
                  return _history_sync_TraktWebAPIUtils__WEBPACK_IMPORTED_MODULE_9__["default"]._getTraktCacheId(activity);
                })))),
                success: function success(response) {
                  ...
                  var _loop = function _loop(key) {
                    ...
                    var activity = parsedActivities.filter(function (parsedActivity) {
                      return _history_sync_TraktWebAPIUtils__WEBPACK_IMPORTED_MODULE_9__["default"]._getTraktCacheId(parsedActivity) === key;
                    })[0];

                    if (activity) {
                      activity.suggestions = json[key].sort(function (a, b) {
                        if (a.count > b.count) {
                          return -1;
                        }
                  ...
                  _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].finishLoadingSuggestions();
                },
                error: function error() {}
              });

            case 39:
              Promise.all(promises).then(_history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].finishLoadingTraktData.bind(_history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"]));
    ...
    function listActivities(_x3, _x4) {
  ...
  getActivities: function getActivities() {
    ...
    var lastPage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].resetActivities();
    _history_sync_ActivityActionCreators__WEBPACK_IMPORTED_MODULE_8__["default"].startLoadingTraktData();
    this.activateAPI().then(function () {
      return _this2.listActivities(page, lastPage);
    });
  },
   ...
   * @returns {Object}
   */
  parseActivity: function parseActivity(activity) {
    var date = moment__WEBPACK_IMPORTED_MODULE_3___default()(activity.date);
    var type = typeof activity.series === "undefined" ? "movie" : "show";
    var itemProps;

    if (type === "show") {
      var title = activity.seriesTitle;
      var epTitle = activity.episodeTitle.trim();
      var season = "";
      var isCollection = false;
      var matches = activity.seasonDescriptor.match(/Season\s(\d+)/);
    ...
    var item = new _Item__WEBPACK_IMPORTED_MODULE_5__["default"](itemProps);
    ...
    return {
      ...
      promise: _history_sync_TraktWebAPIUtils__WEBPACK_IMPORTED_MODULE_9__["default"].getActivity(parsedItem)
    };
  },
  getActivitiesMetadata: function getActivitiesMetadata(activities) {
    var _this3 = this;
    ...
    return new Promise(function (resolve) {
      _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
        method: "POST",
        params: {
          authURL: _this3.authUrl,
          paths: activities.map(function (activity) {
            return ["videos", activity.movieID, ["releaseYear", "summary"]];
          })
        },
        url: "".concat(NETFLIX_API_HOST, "/").concat(_this3.buildIdentifier, "/pathEvaluator?languages=en-US"),
        success: function success(response) {
          var json = JSON.parse(response);
          activities = activities.map(function (activity) {
            var info = json.value.videos[activity.movieID];
  ...
  getMetadata: function getMetadata(id) {
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(resolve) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this4.activateAPI();

              case 2:
                _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
                  method: "GET",
                  url: "".concat(NETFLIX_API_HOST, "/").concat(_this4.buildIdentifier, "/metadata?languages=en-US&movieid=").concat(id),
                  success: function success(response) {
                    resolve(_this4.parseMetadata(response));
                  },
                  error: function error(status, response) {
                    console.log(status, response);
                    resolve(null);
  ...
  parseMetadata: function parseMetadata(response) {
    var json = JSON.parse(response);
    var title = json.video.title;
    var type = json.video.type;
    var year = json.video.year;

    if (type === "show") {
      var episodeInfo;
      var info = json.video.seasons.filter(function (season) {
        return season.episodes.filter(function (episode) {
          var match = episode.id === json.video.currentEpisode;
      ...
      var seasonInfo = info[0];
      var isCollection = seasonInfo.shortName.match(/C/);
      var season = seasonInfo.seq;
      var episode = episodeInfo.seq;
      var epTitle = episodeInfo.title;
...
/* harmony default export */ __webpack_exports__["default"] = (netflixApiUtils);
...
/* harmony import */ var _Request__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Request */ "./src/class/Request.js");
...
function () {
  function Search(options) {
    ...
    this.url = "".concat(_settings__WEBPACK_IMPORTED_MODULE_2__["default"].apiUri, "/search");
    this.showsUrl = "".concat(_settings__WEBPACK_IMPORTED_MODULE_2__["default"].apiUri, "/shows");
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Search, [{
    key: "getUrl",
    value: function getUrl() {
      return "".concat(this.url, "/").concat(this.item.type, "?query=").concat(encodeURIComponent(this.item.title));
    }
  }, {
    key: "findItem",
    value: function findItem(options) {
      ...
      _Request__WEBPACK_IMPORTED_MODULE_3__["default"].send({
        method: "GET",
        url: this.getUrl(),
        success: function success(response) {
          ...
          if (_this.item && _this.item.type === "movie") {
            ...
            data = data.filter(function (item) {
              return item.movie.title === _this.item.title && item.movie.year === _this.item.year;
            })[0];
          } else {
            data = data[0];
          }
        ...
        error: function error(status, response, opts) {
    ...
    key: "getEpisodeUrl",
    value: function getEpisodeUrl(slug) {
      var url;

      if (this.item.isCollection && this.item.epTitle) {
        url = "".concat(this.url, "/episode?query=").concat(encodeURIComponent(this.item.epTitle));
      } else if (this.item.episode) {
        url = "".concat(this.showsUrl, "/").concat(slug, "/seasons/").concat(this.item.season, "/episodes/").concat(this.item.episode, "?extended=images");
      } else {
        url = "".concat(this.showsUrl, "/").concat(slug, "/seasons/").concat(this.item.season, "?extended=images");
      }
    ...
    value: function formatEpisodeTitle(title) {
      return title.toLowerCase().replace(/(^|\s)(a|an|the)(\s)/g, "$1$3").replace(/\s/g, "");
    }
  }, {
    key: "findEpisodeByTitle",
    value: function findEpisodeByTitle(show, response, options) {
      ...
      try {
        for (var _iterator = episodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: "findEpisode",
    value: function findEpisode(options) {
      var _this = this;
      ...
      this.findItem({
        success: function (response) {
          ...
          _Request__WEBPACK_IMPORTED_MODULE_3__["default"].send({
            ...
            error: function error(st, resp, opts) {
...
/***/ "./src/class/content/ContentController.js":
/*!************************************************!*\
  !*** ./src/class/content/ContentController.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _BrowserStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../BrowserStorage */ "./src/class/BrowserStorage.js");
/* harmony import */ var _ItemParser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ItemParser */ "./src/class/ItemParser.js");
/* harmony import */ var _Rollbar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Rollbar */ "./src/class/Rollbar.js");
/* harmony import */ var _Search__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Search */ "./src/class/Search.js");
/* harmony import */ var _Scrobble__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Scrobble */ "./src/class/content/Scrobble.js");
...
function () {
  function ContentController() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, ContentController);
    ...
    if (this.getLocation().match(/watch/)) {
      _ItemParser__WEBPACK_IMPORTED_MODULE_5__["default"].start().then(this.storeItem.bind(this));
    }
  } // For testing purposes.


  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(ContentController, [{
    key: "getLocation",
    value: function getLocation() {
      return location.href;
    }
    ...
    key: "setInactiveIcon",
    value: function setInactiveIcon() {
      browser.runtime.sendMessage({
        type: "setInactiveIcon"
      });
    }
  }, {
    key: "sendAnalyticsEvent",
    value: function sendAnalyticsEvent(options) {
      browser.runtime.sendMessage({
        type: "sendEvent",
        name: options.name,
        value: options.value
    ...
    key: "onScrobbleSuccess",
    value: function onScrobbleSuccess() {
    ...
    key: "onScrobbleError",
    value: function onScrobbleError(status, response, options) {
      this.sendAnalyticsEvent({
        name: "Scrobble",
        value: "onError"
      });
      console.log("traktflix: Scrobble error", status, response, options); // noinspection JSIgnoredPromiseFromCall
    ...
    value: function onSearchSuccess(response) {
      this.sendAnalyticsEvent({
        name: "onSearchSuccess",
        value: this.item.title
      });
      this.scrobble = new _Scrobble__WEBPACK_IMPORTED_MODULE_8__["default"]({
        response: response,
        type: this.item.type,
        success: this.onScrobbleSuccess.bind(this),
        error: this.onScrobbleError.bind(this)
      });
      this.setActiveIcon(); // noinspection JSIgnoredPromiseFromCall
    ...
    key: "reportError",
    value: function () {
      var _reportError = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(type, status, response, options) {
        var _this, storage;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 8;
                return _BrowserStorage__WEBPACK_IMPORTED_MODULE_4__["default"].get("data");
              ...
              case 8:
                ...
                _context.next = 13;
                return _Rollbar__WEBPACK_IMPORTED_MODULE_6__["default"].init();

              case 13:
                _Rollbar__WEBPACK_IMPORTED_MODULE_6__["default"].warning("traktflix: ".concat(type, " error"), {
                  status: status,
                  response: response,
                  options: options
                });
      ...
      function reportError(_x, _x2, _x3, _x4) {
    ...
    key: "onSearchError",
    value: function onSearchError(status, response, options) {
      this.sendAnalyticsEvent({
        name: "onSearchError",
        value: "".concat(status, " - ").concat(this.item.title)
      });
      console.log("traktflix: Search error", status, response, options, this.item.title); // noinspection JSIgnoredPromiseFromCall
    ...
    value: function storeItem(item) {
      ...
      if (this.item !== null) {
        var search = new _Search__WEBPACK_IMPORTED_MODULE_7__["default"]({
          item: this.item
        });
        search.find({
    ...
    value: function onPause() {
      if (typeof this.scrobble !== "undefined") {
        this.setInactiveIcon(); // noinspection JSIgnoredPromiseFromCall
    ...
    value: function getCurrentItem() {
      ...
      if (this.item && this.scrobble) {
        if (this.item.type === "show") {
          item = {
            item: this.scrobble.item.episode
          };
        } else {
          item = {
            item: this.scrobble.item.movie
          };
        }
      }
...
/***/ "./src/class/content/EventWatcher.js":
/*!*******************************************!*\
  !*** ./src/class/content/EventWatcher.js ***!
  \*******************************************/
/*! exports provided: default */
...
function () {
  function EventWatcher(options) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, EventWatcher);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(EventWatcher, [{
    key: "getLocation",
    value: function getLocation() {
      return location.href;
    }
    ...
    key: "onUrlChange",
    value: function onUrlChange(oldUrl, newUrl) {
    ...
    key: "addStopListener",
    value: function addStopListener() {
    ...
    value: function addUrlChangeListener() {
      ...
      this.urlChangeInterval = setTimeout(function () {
        if (_this.url !== _this.getLocation()) {
          _this.onUrlChange(_this.url, _this.getLocation());

          _this.url = _this.getLocation();
        }

        clearTimeout(_this.urlChangeInterval);
    ...
    value: function removeStopListener() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Scrobble; });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
...
function () {
  function Scrobble(options) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, Scrobble);

    if (options.type === "show") {
      this.item = {
        episode: options.response
      };
    } else {
    ...
    this.url = "".concat(_settings__WEBPACK_IMPORTED_MODULE_4__["default"].apiUri, "/scrobble");
    this.success = options.success;
    this.error = options.error;
    this.startProgressTimeout();
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Scrobble, [{
    ...
    key: "startProgressTimeout",
    value: function startProgressTimeout() {
      var _this = this;

      this.progressChangeInterval = setTimeout(function () {
        _this.onProgressChange();

        clearTimeout(_this.progressChangeInterval);

        _this.startProgressTimeout();
      }, 1000);
    }
  }, {
    ...
    key: "getItemInfo",
    value: function () {
      var _getItemInfo = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(path, success) {
        var title, storage, message;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                title = this.item.episode && "".concat(this.item.episode.show.title, " - ").concat(this.item.episode.title) || this.item.movie && this.item.movie.title;
                ...
                _context.next = 5;
                return _BrowserStorage__WEBPACK_IMPORTED_MODULE_5__["default"].get("options");
              ...
              case 5:
                ...
                message = "";
                _context.t0 = path;
                _context.next = _context.t0 === "/start" ? 12 : _context.t0 === "/pause" ? 14 : _context.t0 === "/stop" ? 16 : 18;
                break;
              ...
              case 18:
                this.showNotification("traktflix: ".concat(title), message);
                _context.next = 22;
                break;

              case 21:
                this.showErrorNotification("".concat(browser.i18n.getMessage("couldNotScrobble"), " ").concat(title));
    ...
    key: "stopProgressTimeout",
    value: function stopProgressTimeout() {
      clearInterval(this.progressChangeInterval);
    }
  }, {
    key: "_sendScrobble",
    value: function _sendScrobble(options) {
      var _this2 = this;

      var params = this.item;
      params.progress = this.progress; // noinspection JSIgnoredPromiseFromCall

      _Request__WEBPACK_IMPORTED_MODULE_6__["default"].send({
        method: "POST",
        url: "".concat(this.url).concat(options.path),
        params: params,
        success: function () {
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return _this2.getItemInfo(options.path, true);
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return _this2.getItemInfo(options.path);
...
/***/ "./src/class/history-sync/ActivityActionCreators.js":
/*!**********************************************************!*\
  !*** ./src/class/history-sync/ActivityActionCreators.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ActivityActionCreators; });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modules/history-sync/activity-constants */ "./src/modules/history-sync/activity-constants.js");
/* harmony import */ var _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../modules/history-sync/viewing-activity-app-dispatcher */ "./src/modules/history-sync/viewing-activity-app-dispatcher.js");
...
/*#__PURE__*/
function () {
  function ActivityActionCreators() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ActivityActionCreators);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ActivityActionCreators, null, [{
    key: "finishLoadingSuggestions",
    value: function finishLoadingSuggestions() {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].FINISH_LOADING_SUGGESTIONS
      });
    }
  }, {
    key: "resetActivities",
    value: function resetActivities() {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].RESET_ACTIVITIES
      });
    }
  }, {
    key: "updatePage",
    value: function updatePage(page) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].UPDATE_PAGE,
        page: page
      });
    }
  }, {
    key: "receiveActivities",
    value: function receiveActivities(activities, page) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].RECEIVE_ACTIVITIES,
    ...
    key: "receiveActivitiesFailed",
    value: function receiveActivitiesFailed(status, response) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].RECEIVE_ACTIVITIES_FAILED,
        status: status,
        response: response
      });
    }
  }, {
    key: "startLoadingTraktData",
    value: function startLoadingTraktData() {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].START_LOADING_TRAKT_DATA
      });
    }
  }, {
    key: "finishLoadingTraktData",
    value: function finishLoadingTraktData() {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].FINISH_LOADING_TRAKT_DATA
      });
    }
  }, {
    key: "toggleActivity",
    value: function toggleActivity(activity, value) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].TOGGLE_ACTIVITY,
        activity: activity,
        value: value
      });
    }
    ...
    value: function updateActivity(activity) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].UPDATE_ACTIVITY,
        activity: activity
      });
    }
  }, {
    key: "syncSuccess",
    value: function syncSuccess(episodesCount, moviesCount) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].SYNC_SUCCESS,
    ...
    key: "syncFailed",
    value: function syncFailed(status, response) {
      _modules_history_sync_viewing_activity_app_dispatcher__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch({
        type: _modules_history_sync_activity_constants__WEBPACK_IMPORTED_MODULE_2__["default"].SYNC_FAILED,
        status: status,
        response: response
      });
    }
...
/***/ "./src/class/history-sync/TraktWebAPIUtils.js":
/*!****************************************************!*\
  !*** ./src/class/history-sync/TraktWebAPIUtils.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TraktWebAPIUtils; });
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _BrowserStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../BrowserStorage */ "./src/class/BrowserStorage.js");
/* harmony import */ var _Request__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Request */ "./src/class/Request.js");
/* harmony import */ var _Search__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Search */ "./src/class/Search.js");
/* harmony import */ var _ActivityActionCreators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ActivityActionCreators */ "./src/class/history-sync/ActivityActionCreators.js");
...
var URL = "".concat(_settings__WEBPACK_IMPORTED_MODULE_5__["default"].apiUri, "/sync/history");

var TraktWebAPIUtils =
/*#__PURE__*/
function () {
  function TraktWebAPIUtils() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, TraktWebAPIUtils);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TraktWebAPIUtils, null, [{
    key: "activityUrl",
    value: function activityUrl(activity) {
      if (activity.type === "show") {
        return "".concat(URL, "/episodes/").concat(activity.ids.trakt);
      } else {
        return "".concat(URL, "/movies/").concat(activity.ids.trakt);
      }
    }
  }, {
    key: "addActivities",
    value: function addActivities(activities) {
      ...
      _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
        ...
        success: function success(response) {
          ...
          _ActivityActionCreators__WEBPACK_IMPORTED_MODULE_9__["default"].syncSuccess(json.added.episodes, json.added.movies);
        },
        error: function error(status, response) {
          _ActivityActionCreators__WEBPACK_IMPORTED_MODULE_9__["default"].syncFailed(status, response);
        }
      });
    }
  }, {
    key: "activitiesPayload",
    value: function activitiesPayload(activities) {
      var activitiesToAdd = activities.filter(function (activity) {
        return activity.add;
      });
      var movies = activitiesToAdd.filter(function (activity) {
        return activity.trakt && activity.trakt.type === "movie";
      }).map(TraktWebAPIUtils.activityPayload.bind(TraktWebAPIUtils));
      var episodes = activitiesToAdd.filter(function (activity) {
        return activity.trakt && activity.trakt.type === "show";
      }).map(TraktWebAPIUtils.activityPayload.bind(TraktWebAPIUtils));
      return {
        movies: movies,
        episodes: episodes
    ...
    key: "activityPayload",
    value: function activityPayload(activity) {
      return {
    ...
    key: "_getTraktCacheId",
    value: function _getTraktCacheId(options) {
      var id;

      if (options.netflix.type === "show") {
        id = "".concat(options.netflix.type).concat(options.netflix.title).concat(options.netflix.season || 0).concat(options.netflix.episode || 0).concat(options.netflix.epTitle);
      } else {
        id = "".concat(options.netflix.type).concat(options.netflix.title).concat(options.netflix.year || "");
      }
    ...
    key: "setTraktCache",
    value: function () {
      var _setTraktCache = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(options) {
        var id, storage;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = TraktWebAPIUtils._getTraktCacheId(options);
                _context.next = 3;
                return _BrowserStorage__WEBPACK_IMPORTED_MODULE_6__["default"].get("traktCache");
              ...
              case 3:
                ...
                _context.next = 9;
                return _BrowserStorage__WEBPACK_IMPORTED_MODULE_6__["default"].set({
                  traktCache: JSON.stringify(storage.traktCache)
                });
      ...
      function setTraktCache(_x) {
        return _setTraktCache.apply(this, arguments);
      }

      return setTraktCache;
    }()
  }, {
    key: "getTraktCache",
    value: function () {
      var _getTraktCache = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                storage.traktCache = JSON.parse(storage.traktCache);
                return _context2.abrupt("return", storage.traktCache[id]);
      ...
      function getTraktCache(_x2) {
        return _getTraktCache.apply(this, arguments);
      }

      return getTraktCache;
    }()
  }, {
    key: "getActivity",
    value: function () {
      var _getActivity = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return TraktWebAPIUtils.getTraktCache(options);
              ...
              case 8:
                _context3.next = 10;
                return TraktWebAPIUtils.searchItem(options);

              case 10:
                options.result = _context3.sent;
                _context3.next = 13;
                return TraktWebAPIUtils.setTraktCache(options);

              case 13:
                _context3.next = 15;
                return TraktWebAPIUtils.getActivityHistory(options);
    ...
    value: function getActivityHistory(options) {
      return new Promise(function (resolve, reject) {
        // noinspection JSIgnoredPromiseFromCall
        _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
          method: "GET",
          ...
          success: function success(response) {
            var alreadyOnTrakt = false;
            var history = JSON.parse(response)[0];
            var date;

            if (history && history.watched_at) {
              date = moment__WEBPACK_IMPORTED_MODULE_4___default()(history.watched_at);
              alreadyOnTrakt = date.diff(options.netflix.date, "days") === 0;
            }

            options.trakt = Object.assign(options.result.activity, {
              date: date
            });
    ...
    key: "searchItem",
    value: function searchItem(options) {
      var search = new _Search__WEBPACK_IMPORTED_MODULE_8__["default"]({
        item: options.netflix
      });
      return new Promise(function (resolve, reject) {
        search.find({
          success: function success(response) {
    ...
    key: "getActivityFromURL",
    value: function getActivityFromURL(activity, url) {
      return new Promise(function (resolve, reject) {
        if (!url) {
          reject();
        }

        var pathname = url.replace(/^(https?:\/\/)?(www\.)?trakt\.tv\//, ""); // noinspection JSIgnoredPromiseFromCall

        _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
          method: "GET",
          url: "".concat(_settings__WEBPACK_IMPORTED_MODULE_5__["default"].apiUri, "/").concat(pathname, "?extended=images"),
          success: function success(response) {
            var result = JSON.parse(response);
            var type = activity.netflix.type;

            if (type === "show") {
              var slug = pathname.split("/")[1]; // noinspection JSIgnoredPromiseFromCall

              _Request__WEBPACK_IMPORTED_MODULE_7__["default"].send({
                method: "GET",
                url: "".concat(_settings__WEBPACK_IMPORTED_MODULE_5__["default"].apiUri, "/shows/").concat(slug, "?extended=images"),
                success: function success(res) {
                  result.show = JSON.parse(res);

                  TraktWebAPIUtils._parseActivityFromURL(activity, result, type).then(function (options) {
                    _ActivityActionCreators__WEBPACK_IMPORTED_MODULE_9__["default"].updateActivity(options);
                    resolve();
                  }).catch(reject);
                },
                error: reject
    ...
    key: "_parseActivityFromURL",
    value: function () {
      var _parseActivityFromURL2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(activity, result, type) {
        var traktActivity, options;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                traktActivity = Object.assign(result, {
                  type: type
                });
                options = Object.assign({
                  netflix: activity.netflix
                }, {
                  result: {
                    activity: traktActivity
                  }
                });
                _context4.next = 4;
                return TraktWebAPIUtils.setTraktCache(options);
      ...
      function _parseActivityFromURL(_x4, _x5, _x6) {
        return _parseActivityFromURL2.apply(this, arguments);
      }

      return _parseActivityFromURL;
    }()
  }]);

  return TraktWebAPIUtils;
}();
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _class_BrowserStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../class/BrowserStorage */ "./src/class/BrowserStorage.js");
/* harmony import */ var _class_content_ContentController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../class/content/ContentController */ "./src/class/content/ContentController.js");
/* harmony import */ var _class_content_EventWatcher__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../class/content/EventWatcher */ "./src/class/content/EventWatcher.js");
/* harmony import */ var _class_Rollbar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../class/Rollbar */ "./src/class/Rollbar.js");
...
_class_Rollbar__WEBPACK_IMPORTED_MODULE_5__["default"].init();
var controller = null;
init();
...
function _init() {
  ...
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var storage, eventWatcher;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _class_BrowserStorage__WEBPACK_IMPORTED_MODULE_2__["default"].get("options");

          case 2:
            storage = _context.sent;

            if (!storage.options || !storage.options.disableScrobbling) {
              controller = new _class_content_ContentController__WEBPACK_IMPORTED_MODULE_3__["default"]();
              eventWatcher = new _class_content_EventWatcher__WEBPACK_IMPORTED_MODULE_4__["default"]({
...
function getApiDefs() {
  var netflix = window.netflix || window.wrappedJSObject && window.wrappedJSObject.netflix;

  if (netflix) {
    var authUrl = netflix.reactContext.models.userInfo.data.authURL;
    var buildIdentifier = netflix.reactContext.models.serverDefs.data.BUILD_IDENTIFIER;
    browser.runtime.sendMessage({
      type: "setApiDefs",
      authUrl: authUrl,
...
/***/ "./src/modules/history-sync/activity-constants.js":
/*!********************************************************!*\
  !*** ./src/modules/history-sync/activity-constants.js ***!
  \********************************************************/
/*! exports provided: default */
...
/***/ "./src/modules/history-sync/viewing-activity-app-dispatcher.js":
/*!*********************************************************************!*\
  !*** ./src/modules/history-sync/viewing-activity-app-dispatcher.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (new flux__WEBPACK_IMPORTED_MODULE_0___default.a.Dispatcher());
...
/***/ 1:
/*!********************************************!*\
  !*** multi ./src/modules/content/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/modules/content/index.js */"./src/modules/content/index.js");
